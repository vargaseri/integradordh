...
CREATE TABLE `partida_usuario` (
  ...
  `partida_respuesta_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `partida_id_idx` (`partida_id`),
  KEY `usuario_id_idx` (`usuario_id`),
  KEY `partida_respuesta_id_idx` (`partida_respuesta_id`),
  CONSTRAINT `partida_id` FOREIGN KEY (`partida_id`) REFERENCES `partidas` (`id`),
  CONSTRAINT `partida_respuesta_id` FOREIGN KEY (`partida_respuesta_id`) REFERENCES `pregunta_respuesta` (`id`),
...
-- Dump completed on 2019-11-23  9:32:23
